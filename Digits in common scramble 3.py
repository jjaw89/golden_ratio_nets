...
# print(randomize_many(2))

# point_numbers = randomize_many(500)

# num_digits = 3
# x_numbers = no_consecutive_ones_binary_flipped(num_digits)
# y_numbers = no_consecutive_ones_binary_flipped(num_digits)

# point_numbers = np.array([[x_numbers[n], x_numbers[n]]
#                           for n in range(x_numbers.shape[0])], dtype='int64')
# for _ in range(20):
#     x_numbers_temp = scramble_numbers_2(x_numbers)
#     point_numbers_temp = np.array([[x_numbers[n], x_numbers_temp[n]]
#                                    for n in range(x_numbers.shape[0])], dtype='int64')
#     point_numbers = np.append(point_numbers, point_numbers_temp, axis=0)
#     print(x_numbers_temp)

# print(point_numbers_temp)


# plot_points(convert_integer_points_to_decimals(point_numbers_temp), 3, 3)


num_digits = 1
numbers = no_consecutive_ones_binary_2(num_digits)

point_numbers = np.array([[numbers[n], numbers[n]]
                          for n in range(numbers.shape[0])], dtype='int64')

# y_numbers = no_consecutive_ones_binary_flipped(num_digits)

# for _ in range(100):
#     print(scramble_numbers_2(y_numbers))

print(make_table_digits_in_common_numpy(3)-1)
# print(make_table_digits_in_common_numpy(4)-1)
# print(no_consecutive_ones(3))

# num_digits = 7
# numbers = no_consecutive_ones_binary_flipped(num_digits)
# sort_order = np.argsort(numbers)

# x_numbers_temp = scramble_numbers_2(numbers)[sort_order]
# y_numbers_temp = scramble_numbers_2(numbers)

# point_numbers = np.array([[numbers[n], y_numbers_temp[n]]
#                           for n in range(numbers.shape[0])], dtype='int64')

# plot_points(convert_integer_points_to_decimals(point_numbers), 4, 4)
