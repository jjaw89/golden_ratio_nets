...
# point_values = convert_integer_points_to_decimals(point_numbers)[:5]
# # print(point_values.shape)
print(point_numbers[FIBONACCI[8]:FIBONACCI[9], 1])
# plot_points(point_values, 2, 1)
# plot_points(point_values, 2, 2)
# plot_points(point_values, 3, 2)
# plot_points(point_values, 3, 3)

# m = 4
# plot_points_2(point_values, m, 1, 1)
# m = 6
# plot_points_2(point_values, m, 1, 1)
# m = 10
# plot_points_2(point_values, m, 1, 1)
...
# vector_results = []
# for num_digits in range(1, 29):  # 29
#     start_time = time.perf_counter()
...
# vector_results = []
# for num_digits in range(1, 29):  # 30
#     start_time = time.perf_counter()
...
# for n in range(2, 24):
#     start_time = time.perf_counter()
#     point_set = np.copy(point_values[:FIBONACCI[n+2]])
#     point_set = point_set[point_set[:, 0].argsort()]
#     disc_1 = star_discrepancy_parallel_find_box_correct(point_set)

#     vector_results += [[point_set.shape[0],
#                         disc_1[0, 0], disc_1[0, 1], disc_1[0, 2]]]
#     # print(f'{point_set.shape[0]} : {disc}')
#     mid_time = time.perf_counter() - start_time
#     # [num_digits, point_set.size[0], l2_star_discrepancy(point_set)]
#     arr = np.array(vector_results)
#     # print(arr)
#     pd.DataFrame(arr).to_csv('Discrepancy Sequence.csv')
#     print(f"num points : {point_set.shape}, time so far : {mid_time:0.6f}")
# print(arr)

# vector_results = []
# for num_digits in range(2, 24):
#     start_time = time.perf_counter()
#     point_set = 1-np.copy(point_values[:fibonacci(num_digits+2)])
#     point_set = point_set[point_set[:, 0].argsort()]
