...
def van_der_corput_golden(num):
    num_digits = 6
    digits = no_consecutive_ones_binary_2(num)
    return convert_integers_to_decimals(digits)
...
print(van_der_corput_2(4))

point_set = van_der_corput_golden(30)
vector_results = []
for n in range(1, 500):
    start_time = time.perf_counter()
    point_group = point_set[0:100 * n]
    vector_results += [[point_group.shape[0],
                        star_discrepancy_1_d(point_group)]]
    ...
    print(f"num digits : {100*n}, time so far : {mid_time:0.6f}")


point_set = van_der_corput_2(20)
vector_results = []
for n in range(1, 500):
    start_time = time.perf_counter()
    point_group = point_set[0:100 * n]
...
# vector_results = []
# for num_digits in range(1, 18):
#     start_time = time.perf_counter()
#     point_set = van_der_corput_2(num_digits)
#     print(point_set)
#     vector_results += [[point_set.shape[0],
#                         star_discrepancy_1_d(point_set)]]
#     mid_time = time.perf_counter() - start_time
#     # [num_digits, point_set.size[0], l2_star_discrepancy(point_set)]
#     arr = np.array(vector_results)
#     # print(arr)
