...
def extend_points_randomized(point_numbers, starting_digits):
    ...
    scramble_numbers_m_digits(current_digits, final_x_numbers)
    scramble_numbers_m_digits(current_digits, final_y_numbers)
...
plot_points(convert_integer_points_to_decimals(
    generate_n_scrambled_sequences(10000, 3)), 0, 0, 5)
