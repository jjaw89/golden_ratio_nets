...
l2_star_discrepancy = np.array([0.1250431336113214,
                                0.06940131083312306,
                                0.027098852056446604,
                                0.012171606871291332,
                                0.005276828782976615,
                                0.002290363470429206,
                                0.000989207789566366,
                                0.00042344198855890757,
                                0.00018047145730999171,
                                7.638274551753123e-05,
                                3.218498118645824e-05,
                                1.349133372727327e-05,
                                5.632684191545639e-06,
                                2.3421050284842945e-06,
                                9.704907840666385e-07,
                                4.0080083364018877e-07,
                                1.650338777631937e-07,
                                6.77640175576321e-08,
                                2.775303852432364e-08,
                                1.1339056238208122e-08,
                                4.622474295990501e-09,
                                1.8804573313869013e-09,
                                7.634898942127539e-10,
                                3.0941741088169036e-10,
                                1.2518034258552014e-10,
                                5.056135255112747e-11,
                                2.039061367289016e-11,
                                8.211586015119195e-12,
                                3.3022372787178835e-12,
                                1.3264531232852454e-12])

star_discrepancy_values = np.load(
    r'C:\Users\Jaspar\Dropbox\PythonProjects\star_discrepancy.npy')

values_to_plot = star_discrepancy_values[1:, 0]
print(values_to_plot)
number_of_points = np.array([FIBONACCI[n+2+1]
                            for n in range(values_to_plot.shape[0]+1)])

# print(number_of_points)
# plt.scatter(number_of_points, values_to_plot)
# plt.plot(number_of_points, values_to_plot)
# plt.show()
for n in l2_star_discrepancy:
    print(n)
