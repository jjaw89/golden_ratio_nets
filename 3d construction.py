...
num_digits = 3
x_digits = no_consecutive_ones_reversed(num_digits)
y_digits = no_consecutive_ones(num_digits)

points = np.append(convert_to_decimal(x_digits),
                   convert_to_decimal(y_digits), axis=1)

# plot_points(points, 4, 0)
# plot_points(points, 3, 1)
# plot_points(points, 2, 2)
# plot_points(points, 1, 3)
# plot_points(points, 0, 4)

plot_points(points, 1, 0)
