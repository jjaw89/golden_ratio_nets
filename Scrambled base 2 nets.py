...
#         sobol = qmcpy.Sobol(2)
#         point_set = sobol.gen_samples(2**m)

#         point_set = point_set[point_set[:, 0].argsort()]
#         # result += [((version_3_l2_star_discrepancy(point_set))**.5).real]
#         result += [star_discrepancy_parallel(point_set)]
...
#     # print(arr)
#     pd.DataFrame(arr).to_csv('Star Discrepancy Scrambled Sobol.csv')
#     print(f"Num points : {2**m}, Time so far : {mid_time:0.6f}")
# # print(arr)
