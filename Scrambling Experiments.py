...
# # plot_points_point_size_10(points, num_digits, num_digits)

# convert_to_points_and_scramble_tail_end(point_numbers)
...
# point_numbers = np.array([[x_numbers[n], y_numbers[n]]
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# point_numbers_temp = scramble_non_zero_digits_back_tracking(
...
#     for _ in range(2**n):
#         point_numbers_temp = scramble_non_zero_digits_no_back_tracking(
#             np.copy(point_numbers))
#         # scramble_non_zero_digits_no_back_tracking(
#         #     point_numbers_temp)
#         # scramble_non_zero_digits_no_back_tracking(
#         #     point_numbers_temp)
#         # scramble_non_zero_digits_no_back_tracking(
...
#         # scramble_non_zero_digits_no_back_tracking(
#         #     point_numbers_temp)
#         for point in point_numbers_temp:
#             # print(point)
#             point_count[point[0], point[1]] += 1
#     point_count_2 = np.copy(point_count[x_numbers][:, x_numbers])
#     reshape_point_count = np.sort(np.reshape(
#         point_count_2, x_numbers.shape[0]**2))
#     print(f'{2**(n+1)} , {reshape_point_count[0]/reshape_point_count[-1]}')
...
# multiplier = np.array([[x // 2**(num_digits-1)+y // 2**(num_digits-1)
#                       for x in y_numbers] for y in y_numbers])
# print(multiplier)
...
# point_numbers = np.array([[x_numbers[n], y_numbers[n]]
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# scramble_non_zero_digits_back_tracking(point_numbers)
# points = convert_integer_points_to_decimals(point_numbers)
# plot_points_point_size_10(points, num_digits, num_digits)
...
# vector_results_1 = []
# vector_results_2 = []
# for num_digits in range(1, 22):  # 19
#     start_time = time.perf_counter()
...
#         point_set = scramble_and_convert_to_points_best(point_numbers)
...
#     # print(arr)
#     pd.DataFrame(arr_1).to_csv('L2 star Discrepancy Scrambled Sequence 2.csv')
#     arr_2 = np.array(vector_results_2)
#     # print(arr)
#     pd.DataFrame(arr_2).to_csv('Star Discrepancy Scrambled Sequence 2.csv')
...
# point_numbers = np.array([[x_numbers[n], y_numbers[n]]
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# generate_weights(point_numbers)
# # for _ in range(40):
# #     point_numbers_temp = scramble_non_zero_digits_back_tracking(
# #         np.copy(point_numbers))
# #     generate_weights(point_numbers_temp)
# print(FIBONACCI[num_digits+1]**2 * GOLDEN_RATIO **
#       (-2*num_digits)*FIBONACCI[num_digits+2])
# print(FIBONACCI[num_digits+1]*FIBONACCI[num_digits] * GOLDEN_RATIO **
#       (-2*num_digits-1)*FIBONACCI[num_digits+2])
# print(FIBONACCI[num_digits]**2 * GOLDEN_RATIO **
#       (-2*num_digits-2)*FIBONACCI[num_digits+2])
# print()
# print(FIBONACCI[num_digits+1]**2 / FIBONACCI[num_digits+2])
# print(2*FIBONACCI[num_digits+1] *
#       FIBONACCI[num_digits] / FIBONACCI[num_digits+2])
# print(FIBONACCI[num_digits]**2 / FIBONACCI[num_digits+2])
...
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# # print(point_numbers)
# # print(np.reshape(point_numbers, (FIBONACCI[num_digits+2], 1, 2)))
# point_count = np.zeros(
#     (FIBONACCI[num_digits+2], x_numbers[-1]+1, x_numbers[-1]+1), dtype='int')
# point_numbers_temp = np.reshape(scramble_no_back_tracking_times_4(
#     point_numbers), (FIBONACCI[num_digits+2], 1, 2))
# # print(point_numbers_temp)

# for j in range(50):
#     point_numbers_temp = np.reshape(scramble_back_tracking_times_m(
#         point_numbers, 6), (FIBONACCI[num_digits+2], 1, 2))
#     for _ in range(10000-1):
#         point_numbers_temp = np.append(point_numbers_temp,
#                                        np.reshape(scramble_back_tracking_times_m(point_numbers, 6), (FIBONACCI[num_digits+2], 1, 2)), axis=1)
#     print()
#     for n in range(FIBONACCI[num_digits+2]):
#         for point in point_numbers_temp[n]:
#             # print(point)
#             point_count[n, point[0], point[1]] += 1
#     for n in range(FIBONACCI[num_digits+2]):
#         point_count_2 = point_count[n][x_numbers][:, x_numbers]
#         reshape_point_count = np.sort(np.reshape(
#             point_count_2, x_numbers.shape[0]**2))
#         print(
#             f'{(j+1) * 10000},{n},{reshape_point_count[0]/reshape_point_count[-1]}')
...
# point_numbers = np.array([[x_numbers[n], y_numbers[n]]
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# scrambled_point_numbers = scramble_non_zero_digits_no_back_tracking(
#     np.copy(point_numbers))
# # scrambled_point_numbers = np.copy(point_numbers)
# points = convert_to_points_and_scramble_tail_end(scrambled_point_numbers)
# for _ in range(10000):
#     scrambled_point_numbers = scramble_non_zero_digits_no_back_tracking(
#         np.copy(point_numbers))
#     # scrambled_point_numbers = np.copy(point_numbers)
#     points = np.append(
#         points, convert_to_points_and_scramble_tail_end(scrambled_point_numbers), axis=0)
...
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# print(point_numbers)
# # print(convert_numbers_to_digits(point_numbers[:, 1], 5))
# # print(convert_point_numbers_to_digits(point_numbers, 5))
# for k in range(5):
#     print(k)
#     point_numbers = scramble_non_zero_digits_no_back_tracking(point_numbers)
#     x_numbers = no_consecutive_ones_binary_flipped(num_digits)
#     y_numbers = point_numbers[:, 1]
#     point_numbers_2 = np.array([[x_numbers[n], y_numbers[n]]
#                                 for n in range(x_numbers.shape[0])], dtype='int64')
#     print(convert_point_numbers_to_digits(point_numbers_2, num_digits))
#     plot_points(
#         convert_integer_points_to_decimals(point_numbers_2), 2, 0)

    # print(convert_numbers_to_digits(point_numbers[:, 1], 5))
    # y_numbers = no_consecutive_ones_binary_flipped(num_digits)
    # x_numbers = point_numbers[:, 1]
    # point_numbers_2 = np.array([[x_numbers[n], y_numbers[n]]
    #                             for n in range(x_numbers.shape[0])], dtype='int64')
    # # print(convert_point_numbers_to_digits(point_numbers_2, 5))
    # plot_points_point_size_10(
    #     convert_integer_points_to_decimals(point_numbers_2), 5, 0)
...
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# print(convert_point_numbers_to_digits(point_numbers, 5))
# plot_points_point_size_5(
#     convert_integer_points_to_decimals(point_numbers), 5, 0)
# plot_points(
#     convert_integer_points_to_decimals(point_numbers), 5, 0)
...
# y_numbers = no_consecutive_ones_binary_flipped(num_digits)
# for n in range(32):
#     if np.sum(y_numbers // 2 ** n) == 0:
#         break
# for _ in range(200):
#     for m in range(1, n+1):
#         y_numbers = scramble_numbers_m_digits(n+1-m, y_numbers)
# x_numbers = no_consecutive_ones_binary_flipped(num_digits)
...
# point_numbers = np.array([[x_numbers[n], y_numbers[n]]
#                          for n in range(x_numbers.shape[0])], dtype='int64')
# plot_points(convert_integer_points_to_decimals(point_numbers), 0, 0)
