...
# print('increasing flipped')
# print(np.flip(numbers_to_digits(increasing_whole_numbers_2(
#     num_digits, a, b), num_digits, a), axis=1))
# print('hammersley')
# print(hammersley_digits(num_digits, a, b))
...
# a = 2
# b = 1
# ALL_VAN_DER_CORPUT_GPU = cp.asarray(van_der_corput_numbers(num_digits, a, b))
# print()
...
# print()
# # print('Increasing')
# # print(numbers_to_digits(increasing_whole_numbers_2(
# #     num_digits, a, b), num_digits, a))
# # print()

# print('van der Corput flip')
# print(np.flip(numbers_to_digits(van_der_corput_numbers(
#     num_digits, a, b), num_digits, a), axis=1))
# print()
# print('Increasing flip')
# print(np.flip(numbers_to_digits(increasing_whole_numbers_2(
#     num_digits, a, b), num_digits, a), axis=1))

# print(4294967295 - increasing_whole_numbers_2(num_digits, a, b)[-1])
# print()
# numbers = cp.asarray(increasing_whole_numbers_2(
#     num_digits, a, b))
# start_time = time.perf_counter()
# scramble_mth_digit_general(increasing_whole_numbers_2(
#     num_digits, a, b), num_digits, a, b)
# total_time = time.perf_counter() - start_time
# print(f'time : {total_time}, num_digits : {num_digits}, a : {a}, b : {b}')
...
# for num_digits in range(1, 13):
#     # num_digits = 12
#     a = 2
#     b = 2
#     point_numbers = hammersley_numbers(num_digits, a, b)
#     print(point_numbers[-1])

#     start_time = time.perf_counter()
#     point_numbers = scramble_non_zero_point_digits(
#         point_numbers, num_digits, a, b)
#     total_time = time.perf_counter() - start_time

#     point_values = points_to_values(point_numbers, num_digits, a, b)
#     print(total_time)
#     # plot_points(hammersley_values_2(num_digits, a, b), a, b, 1, 1, 10)
#     plot_points(point_values, a, b, 0, 0, 5)

# num_digits = 1
# a = 2
# b = 1

# print(f'a = {a} and b = {b}, {num_digits} digit numbers such that digit to the right of a is strictly less than b')
# print(np.flip(numbers_to_digits(increasing_whole_numbers_2(
#     num_digits, a, b), num_digits, a), axis=1))
# print('partition endpoints')
# print(increasing_whole_numbers_values_2(num_digits, a, b).reshape(
#     (increasing_whole_numbers_2(num_digits, a, b).shape[0], 1)))
...
# print(increasing_whole_numbers_values_2(num_digits, a, b).reshape(
#     (increasing_whole_numbers_2(num_digits, a, b).shape[0], 1)))
# for num_digits in range(3, 4):

#     if 100000 - num_whole_numbers(num_digits, a, b) * (100000 // num_whole_numbers(num_digits, a, b)) < 100000 - num_whole_numbers(num_digits, a, b) * (1+100000 // num_whole_numbers(num_digits, a, b)):
#         n = (100000 // num_whole_numbers(num_digits, a, b))
#     else:
#         n = (100000 // num_whole_numbers(num_digits, a, b))+1
#     start_time = time.perf_counter()

#     point_values = scrambled_hammersley_set_extra_end(num_digits, a, b)

#     for _ in range(2*n-1):
#         point_values = np.append(
#             point_values, scrambled_hammersley_set_extra_end(num_digits, a, b), axis=0)
#     total_time = time.perf_counter() - start_time
#     print(point_values.shape[0])
#     print(total_time)
#     plot_points(point_values, a, b, 0, 0, 1)

# print(hammersley_values(num_digits, a, b)[:, 0])
# print(np.flip(1-hammersley_values(num_digits, a, b)[:, 0]))
# # print(hammersley_digits(num_digits, a, b)[:, 1])
# # for n in range(5):
# #     print(num_whole_numbers(n, a, b))
# # plot_points(hammersley_values_2(num_digits, a, b),
# #             a, b, num_digits, num_digits, 15)
# # plot_points(hammersley_values_2(0, a, b),
# #             a, b, 2, 0, 15)
# # plot_points(hammersley_values_2(0, a, b),
# #             a, b, 1, 1, 15)
# # plot_points(hammersley_values_2(0, a, b),
...
# plot_points(hammersley_values_2(num_digits, a, b),
#             a, b, num_digits, num_digits, 15)
# plot_points(hammersley_values_2(num_digits, a, b), a, b, 3, 0, 15)
# plot_points(hammersley_values_2(num_digits, a, b), a, b, 2, 0, 15)
# # plot_points(hammersley_values_2(num_digits, a, b), a, b, 1, 1, 15)
# plot_points(hammersley_values_2(num_digits, a, b), a, b, 2, 2, 15)


# for a in range(2, 6):
#     for b in range(1, a+1):
#         prev = num_whole_numbers(1, a, b)
#         for n in range(2, 32):
#             if abs(num_whole_numbers(n, a, b) - 100000) > abs(prev - 100000):
#                 break
#             prev = num_whole_numbers(n, a, b)
#         print(f'a = {a}, b = {b}')
#         print(f'Time, num digits, num points, star disc,star disc scrambled,star disc scrambled 2, normalized star disc,normalized star disc scrambled,normalized star disc scrambled 2, l2 star disc, l2 star disc scrambled, l2 star disc scrambled 2,normalized l2,normalized star disc scrambled,normalized l2 scrambled 2')
...
#             points = hammersley_values_2(num_digits, a, b)
#             result = star_discrepancy_largest_rest(points)
#             star_disc_start = max(result[0, 0], result[1, 0])
#             l2_star_disc_start = math.sqrt(
#                 version_3_l2_star_discrepancy(points))
#             for _ in range(10):
#                 points = scrambled_hammersley_set(num_digits, a, b)
#                 result = star_discrepancy_largest_rest(points)
#                 star_disc += max(result[0, 0], result[1, 0])
#                 l2_star_disc += math.sqrt(version_3_l2_star_discrepancy(points))
#             # total_time = time.perf_counter() - start_time
#             star_disc /= 10
#             l2_star_disc /= 10
#             for _ in range(10):
#                 points = scrambled_hammersley_set_extra_end(num_digits, a, b)
#                 result = star_discrepancy_largest_rest(points)
#                 star_disc_2 += max(result[0, 0], result[1, 0])
#                 l2_star_disc_2 += math.sqrt(
#                     version_3_l2_star_discrepancy(points))
#             total_time = time.perf_counter() - start_time
#             star_disc_2 /= 10
#             l2_star_disc_2 /= 10
#             print(
#                 f'{total_time}, {num_digits}, {points.shape[0]},{star_disc_start},{star_disc},{star_disc_2},{star_disc_start / (math.log10(points.shape[0]) / points.shape[0])},{star_disc / (math.log10(points.shape[0]) / points.shape[0])},{star_disc_2 / (math.log10(points.shape[0]) / points.shape[0])},{l2_star_disc_start},{l2_star_disc},{l2_star_disc_2},{l2_star_disc_start / (math.log10(points.shape[0]) / points.shape[0])},{l2_star_disc / (math.log10(points.shape[0]) / points.shape[0])},{l2_star_disc_2 / (math.log10(points.shape[0]) / points.shape[0])}')
#         print()
#         print()

# all_points = qmcpy.DigitalNetB2(dimension=2, randomize=True,
#                                 graycode=False).gen_samples(n_min=0, n_max=2**8)
# for _ in range(1000):
#     all_points = np.append(all_points, qmcpy.DigitalNetB2(dimension=2, randomize=True,
#                                                           graycode=False).gen_samples(n_min=0, n_max=2**8), axis=0)
# plot_points(all_points, 1, 1, 0, 0, 1)

# for num_digits in range(1, 20):
#     points = np.copy(all_points[:2**num_digits])
#     result = star_discrepancy_largest_rest(points)
#     star_disc_start = max(result[0, 0], result[1, 0])
#     l2_star_disc_start = math.sqrt(
#         version_3_l2_star_discrepancy(points))\
...
#     print(
#         f' {num_digits}, {points.shape[0]}, {star_disc_start}, {star_disc_start / (math.log10(points.shape[0]) / points.shape[0])}, {l2_star_disc_start}, {l2_star_disc_start / (math.log10(points.shape[0]) / points.shape[0])}')

# a = 2
# b = 2
# for num_digits in range(7, 15):

#     point_values = np.copy(all_points[:2**num_digits])

#     print(
#         f'SOBOL num digits is {num_digits} number of points is {point_values.shape[0]}')
#     plot_points(point_values, a, b, 0, 0, 5)

# for n in range(20):
#     print(f'{n}: {num_whole_numbers(n, 2, 2)}')

# for n in range(24):
#     print(f'{n}: {2**n}')

# base = 1 / (math.sqrt(2)-1)
# for m in range(4):
#     print(f'{base ** -m} : {2 * base ** -m}')
# print()
# base = 1 + math.sqrt(2)
# for m in range(4):
#     print(f'{base ** -m} : {2 * base ** -m}')
...
# base = math.sqrt(2)
# for m in range(4):
#     print(f'{base ** (-2*m-1)} : {2 * base ** (-2*m-1)}')
#     print(f'{sqrt(2)*(2**-m)}')

# num_digits = 14
# base_2 = van_der_corput_values(num_digits, 3, 1)
# num_digits = 26
# base_3 = van_der_corput_values(num_digits, 1, 1)
# halton_sequence = np.array([[base_2[n], base_3[n]] for n in range(250000)])
# # print(halton_sequence[:10])
# n = 10000
# plot_points(halton_sequence[:n], 1, 1, 0, 0, 1)

# for num_digits in range(1, 16):
#     points = hammersley_values_rationals_2(num_digits, 2, 1)
#     result = star_discrepancy_largest_rest(points)
#     if result[0, 0] > result[1, 0]:
#         index = 0
#         maxi = result[0, 0]
...
#     print(
#         f'{num_digits}, {points.shape[0]}, {maxi},{result[index,1]},{result[index,2]}, {maxi / (math.log10(points.shape[0])/points.shape[0])}')

# plot_points(hammersley_values_2(10, 2, 1), 2, 1, 0, 0, 3)
# plot_points(hammersley_values_rationals(10, 2, 1), 2, 1, 0, 0, 3)
# plot_points(hammersley_values_rationals_2(10, 2, 1), 2, 1, 0, 0, 3)


# for num_digits in range(5):
#     plot_points(hammersley_values_2(num_digits, 2, 2),
#                 2, 2, num_digits, num_digits, 10)

# print(hammersley_digits(3, 2, 2))
