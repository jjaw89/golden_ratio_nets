...
#     max_discrepancy = 0
#     discrepancy = 0
#     # discrepancy = np.zeros(point_set.shape[0], dtype='float')
#     for j in range(n):
#         count[y_sort[j]:] += 1
#         # print(j, ',', point_set[j, 1], ',', y_sort[j], ',', count)
#         for k in range(j+1):
...
# @njit(parallel=True)
# def count_plus_one(count, j):
#     for k in prange(j, count.shape[0]):
#         count[k] += 1
#     return count
...
# b = 3
# num_digits = 9
# save_points_to_txt(hammersley_values(
#     num_digits, a, b), a, b, num_digits, folder)
# a = 3
# b = 1
# num_digits = 13
# save_points_to_txt(hammersley_values(
...
#         for num_digits in range(20):
#             n = num_whole_numbers(num_digits, a, b)
#             if 5000000 > n:
#                 save_points_to_txt(hammersley_values(
#                     num_digits, a, b), a, b, num_digits, folder)
#             if n > 5000000:
...
#         print()
# start_time = time.perf_counter()
# for num_digits in range(3, 19):

#     # print()
#     # print(
#     #     f'***Hammersley set with a={a} and b={b} and {num_digits} digits is:')
#     check_t_is_one(num_digits, a, b)
...
#             if 5000000 > n:
#                 print(
#                     f' {num_whole_numbers(num_digits, a, b)}')
#             # if n > 000000:
#             #     print(
#             #         f'{a},{b}, {num_digits}, {num_whole_numbers(num_digits, a, b)}')
#             #     # print('----------------')
#     # print(
#     #     f'a={a}, b={b}, num digits={num_digits}, num points={num_whole_numbers(num_digits, a, b)}')
#             else:
#                 break
# print()
...
# for num_digits in range(3, 14):

a = 2
b = 2
num_digits = 2

points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# star_discrepancy_largest_rest(points)
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')

# points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# print(star_discrepancy_last_try(points))
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
...
# points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# print(star_discrepancy_last_try_2(points))
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
...
# points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# print(star_discrepancy_last_try_3(points))
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
...
for num_digits in range(1, 12):
    ...
    points = hammersley_values(num_digits, a, b)
    # start_time = time.perf_counter()
    # # print(star_discrepancy_largest_rest(points)[0, 0])
    # star_discrepancy_largest_rest(points)[0, 0]
    # end_time_1 = time.perf_counter() - start_time

    # start_time = time.perf_counter()
    # # print(star_discrepancy_last_try(points))
    # star_discrepancy_last_try(points)
    # end_time_2 = time.perf_counter() - start_time

    # start_time = time.perf_counter()
    # # print(star_discrepancy_last_try_2(points))
    # star_discrepancy_last_try_2(points)
    # end_time_3 = time.perf_counter() - start_time
    # # print(
    #     f'{num_digits}, {end_time_1}, {end_time_2}, {end_time_3}')
    start_time = time.perf_counter()
    # print(star_discrepancy_last_try_3(points))
    star_discrepancy_last_try_3(points)
    end_time_4 = time.perf_counter() - start_time
    print(num_digits, end_time_4)

    # start_time = time.perf_counter()
    # print(star_discrepancy_last_try_3_gpu(points))
    # # star_discrepancy_last_try_3(points)
    # end_time_4 = time.perf_counter() - start_time
    # print('gpu', num_digits, end_time_4)
    # print(
    #     f'{num_digits}, {end_time_1}, {end_time_2}, {end_time_3}, {end_time_4}')
    print()
# points = hammersley_values(num_digits, a, b)


# start_time = time.perf_counter()
# print(star_discrepancy_last_try_gpu(points))
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
# points = hammersley_values(num_digits, a, b)
...
# start_time = time.perf_counter()
# print(star_discrepancy_gpu(points))
# end_time = time.perf_counter()
# print(
#     f'gpu num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
# start_time = time.perf_counter()
# print(star_discrepancy_gpu(points))
# end_time = time.perf_counter()
# print(
...
# points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# print(star_discrepancy_largest_rest_optimized(points)[0])
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
...
# points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# print(star_discrepancy_gpt(points))
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
# points = hammersley_values(num_digits, a, b)
...
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
# start_time = time.perf_counter()
# print(star_discrepancy_sec(points))
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
...
# points = hammersley_values(num_digits, a, b)
# start_time = time.perf_counter()
# result = discrepancies.star_discrepancy_largest_rest(points, points.shape[0])
# print("Max Closed:", result)
# # print(result.max_closed, result.max_closed_right, result.max_closed_top)
# end_time = time.perf_counter()
# print(
#     f'num_digits={num_digits}, Calculation took {end_time-start_time} seconds.')
...
#     print(f'{num_digits}: {num_whole_numbers(num_digits,a,b)},  {num_whole_numbers_2(num_digits, a, b)}, {num_whole_numbers_2_highest_digit_less_than_b(num_digits, a, b)}, {van_der_corput_ending_less_than_a(num_digits, a, b)}')
# print(hammersley_digits(num_digits, a, b))
# check_t_value(num_digits, a, b)
# plot_points(hammersley_values(3, a, b), a, b, 1, 1, 10)
# plot_points(hammersley_values(3, a, b), a, b, 1, 1, 10)

# for num_digits in range(5):
#     print(num_digits)
#     print(num_whole_numbers_2_highest_digit_less_than_b(num_digits, a, b))
#     print(van_der_corput_numbers(
#         num_digits, a, b))
#     print()

# plot_points(hammersley_values(5, a, b), a, b, 1, 4, 10)
# plot_points(hammersley_values(4, a, b), a, b, 3, 1, 10)
# print(hammersley_digits(5, a, b))
# b = 4
# num_digits = 5
# check_t_value(num_digits, a, b)
# for x in range(num_digits-1):
#     plot_points(hammersley_values(0, a, b),
#                 a, b, x, num_digits-2-x, 10)
# for x in range(num_digits):
#     plot_points(hammersley_values(0, a, b),
# #                 a, b, x, num_digits-1-x, 10)
# plot_points(hammersley_values(num_digits, a, b),
#             a, b, 1, 1, 10)
# plot_points(hammersley_values(num_digits, a, b),
#             a, b, 2, 1, 10)
# plot_points(hammersley_values(num_digits, a, b),
...
# print(hammersley_numbers(3, 2, 1)[:, 0])
# # print(hammersley_values(3, 2, 1)[:, 0])
# # print(hammersley_digits(3, 2, 1)[:, 0])
# print()
# print(hammersley_numbers(3, 2, 1)[:, 1])
# # print(hammersley_values(3, 2, 1)[:, 1])
# # print(hammersley_digits(3, 2, 1)[:, 1])
